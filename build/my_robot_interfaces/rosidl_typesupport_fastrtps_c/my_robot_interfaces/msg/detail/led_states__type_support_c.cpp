...
#include "rosidl_runtime_c/primitives_sequence.h"  // led
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // led
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: led
  {
    size_t size = ros_message->led.size;
    auto array_ptr = ros_message->led.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: led
  {
    ...
    if (ros_message->led.data) {
      rosidl_runtime_c__boolean__Sequence__fini(&ros_message->led);
    }
    if (!rosidl_runtime_c__boolean__Sequence__init(&ros_message->led, size)) {
      fprintf(stderr, "failed to create array for field 'led'");
      return false;
    }
    auto array_ptr = ros_message->led.data;
  ...
  size_t current_alignment)
{
  ...
  // field.name led
  {
    size_t array_size = ros_message->led.size;
    auto array_ptr = ros_message->led.data;

...
class Init_SetLed_Request_number
{
public:
  Init_SetLed_Request_number()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetLed_Request_state number(::my_robot_interfaces::srv::SetLed_Request::_number_type arg)
  {
...
{
  return my_robot_interfaces::srv::builder::Init_SetLed_Request_number();
}
